...
namespace AlgoDemos.Graph
{
    class DiWtedGraphAdjMatr
    {
        ...
        public void Demo()
        {
            DiWtedGraphAdjMatr g = new DiWtedGraphAdjMatr();
            int choice;
            String s1, s2;
            ...
            while (true)
            {
                ...
                switch(choice)
                {
                    ...
                    case 3:
                        ...
                        try
                        {
                            g.InsertEdge(s1, s2, 10); // TODO: make the weight as random between say 1 to 100
