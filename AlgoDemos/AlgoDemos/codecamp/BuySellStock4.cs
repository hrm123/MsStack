...
namespace AlgoDemos.codecamp
{
    ...
    internal class BuySellStock4
    {
        ...
        public static void TestCase_works_3()
        {
            BuySellStock4 bss4 = new BuySellStock4();
